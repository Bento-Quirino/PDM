## Instruções Gerais para os Grupos

- **Cada grupo deve ter até 5 integrantes**.
- **Gerar um APK** para cada projeto, incluindo um **ícone** e uma **tela de splash** personalizada.
- Criar um **README** com as seguintes informações:
  - O que é o projeto
  - Bibliotecas usadas
...
| Projeto                     | Observações                                                                                                           | Grupo                          |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------|
| Diário de Fotos             | Use `expo-camera` para tirar fotos. Notificação: "Mais uma foto para a galeria!"                                     | Haroldo                               |
...
| Monitor de Passos           | Use `expo-sensors` para monitorar passos dados diariamente. Notificação: "Novo registro de passos adicionado!"      | Hayashida                               |
| Previsão do Tempo           | Use `axios` para acessar uma API de previsão do tempo. Notificação: "Previsão atualizada com sucesso!"               |                                |

> **Observação**: Cada grupo deve organizar-se para cumprir as tarefas do projeto e documentar bem o processo.
>
> Entrega até 23:59 do dia 13/11/2024
